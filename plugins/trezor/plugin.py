...
class TrezorCompatibleWallet(BIP44_HW_Wallet):
    ...
    def sign_message(self, address, message, password):
        ...
        address_path = self.address_id(address)
        address_n = client.expand_path(address_path)
        msg_sig = client.sign_message(client.coin_name(), address_n, message)
...
class TrezorCompatiblePlugin(HW_PluginBase):
    ...
    def sign_transaction(self, wallet, tx, prev_tx, xpub_path):
        ...
        signed_tx = client.sign_tx(client.coin_name(), inputs, outputs)[1]
    ...
    def show_address(self, wallet, address):
        ...
        address_n = client.expand_path(address_path)
        client.get_address(client.coin_name(), address_n, True)
